...
class mstats(loader.Module):
    ...
    async def watcher(self, message):
        ...
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "💫" in message.raw_text:
            ...
            self.set("zvd1", zvd1)
            self.set("zv1",zv1)
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "Плазма +" in message.raw_text and "Руда на уровень" in message.raw_text:
            plpt = r"\d+"
