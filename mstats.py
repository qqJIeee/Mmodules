...
class mstats(loader.Module):
    ...
    async def hnext(self, call: InlineCall):
        await call.edit(
            text="<b>1. Напиши .stn чтобы установить свой ник\n\nНапишите .drest чтобы сбросить время в статистике(у вас сначало будет 53г.)\n\n2. Всё, спасибо за внимание можете пользоваться</b>",
            reply_markup=[
                [
                    {
                        "text" : "🔻 Закрыть",
    ...
    async def watcher(self, message):
        ...
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "💫" in message.raw_text:
            ...
            self.set("zvd1", zvd1)
            self.set("zv1",zv1)
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "🎆 Ты нашел(ла) 2 плазмы." in message.raw_text:
            p += 2
            shdp += 2
            self.set("shdp", shdp)
            dayp += 2 
            self.set("p",p)
            self.set("dayp",dayp)
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "🎆 Ты нашел(ла) 1 плазму." in message.raw_text:
            p += 1
            dayp += 1 
            shdp += 1
            self.set("shdp", shdp)
        ...
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "✨ Твоя награда:" in message.raw_text:
            ...
            if match:
                ...
                self.set("pb",pb)
                self.set("dayp",dayp)
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "Руды до след. ур.:" in message.raw_text:
            klks += 1
            klksd += 1
        ...
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "передал(а) тебе" in message.text and "🌌" in message.text:
            ...
            self.set("zvvd", zvvd)
            self.set("zvv",zvv)
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "🗡" in message.raw_text and "нанес(ла) удар" in message.text:
            ddmg = message.text.index("нанес(ла) удар  (<b>-") + len("нанес(ла) удар  (<b>-")
            dddmg = message.text.index("</b> оз)", ddmg)
            ddmgr = message.text[ddmg:dddmg]
            bdmg += int(ddmgr)
            bddmg += int(ddmgr)
            self.set("bddmg", bddmg)
            self.set("bdmg",bdmg)
        if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "💢" in message.raw_text and "нанес(ла) крит. удар!" in message.text:
            kddmg = message.text.index("нанес(ла) крит. удар!  (<b>-") + len("нанес(ла) крит. удар!  (<b>-")
            kdddmg = message.text.index("</b> оз)")
            kddmgr = message.text[kddmg:kdddmg]
            bkdmg += int(kddmgr)
            bkddmg += int(kddmgr)
    ...
    async def ansst(self, message):
        ...
        if hhhhh < 1 and mmmmm > 1:
            await self.client.send_message(
                message.peer_id,
                f"<b>📊 | Статистика игрока <code>{im}</code></b>за <i>{mmmm}мин.{ss}с.:</i>\n\n<b>🧱 | В шахте :</b>\n\n👆 | <b>За <code>{klks}</code> {klkr}\n\n<b>✉️ | Конверт : <code>{kt1}</code>\n🧧 | Редкий Конверт : <code>{rkt1}</code>\n📦 | Кейс : <code>{k1}</code>\n🗳 | Редкий Кейс : <code>{rk1}</code>\n🕋 | Мифический Кейс : <code>{mif1}</code>\n💎 | Кристальный Кейс : <code>{kr1}</code>\n🌌 | Звёздный Кейс : <code>{zv1}</code></b> \n<i>Всего кейсов с шахты:</i> <code>{shcs}</code>\n\n<b>🎆 | Плазма : <code>{p}</code>\n⚡️ | Бусты : <code>{boostsss}</code></b>\n\n☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>\n\n🎁 | <b>Трейды :\n\n✉️ | Конверты : <code>{ktt}</code>\n🧧 | Редкие Конверты : <code>{rkkt}</code>\n📦 | Кейсы : <code>{kk}</code>\n🗳 | Редкий Кейс : <code>{rkk}</code>\n🕋 | Мифический Кейс : <code>{miff}</code>\n💎 | Кристальный Кейс : <code>{kkr}</code>\n🌌 | Звёздный Кейс : <code>{zvv}</code></b>\n\n<b>📚 | Прочее :\n\n🌐 | Плазмы с 'thx' когда благодаришь ты : <code>{pthx}</code>\n🌐 | Плазмы с 'thx' когда благодарят тебя :</b> <code>{ppthx}</code>")
        ...
        if ddddd < 1 and hhhhh > 0:
            await self.client.send_message(
                message.peer_id,
                f"<b>📊 | Статистика игрока <code>{im}</code></b>за <i>{hhhh}ч.{mmmm}мин.{ss}с.:</i>\n\n<b>🧱 | В шахте :</b>\n\n👆 | <b>За <code>{klks}</code> {klkr}\n\n<b>✉️ | Конверт : <code>{kt1}</code>\n🧧 | Редкий Конверт : <code>{rkt1}</code>\n📦 | Кейс : <code>{k1}</code>\n🗳 | Редкий Кейс : <code>{rk1}</code>\n🕋 | Мифический Кейс : <code>{mif1}</code>\n💎 | Кристальный Кейс : <code>{kr1}</code>\n🌌 | Звёздный Кейс : <code>{zv1}</code></b> \n<i>Всего кейсов с шахты:</i> <code>{shcs}</code>\n\n<b>🎆 | Плазма : <code>{p}</code>\n⚡️ | Бусты : <code>{boostsss}</code></b>\n\n☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>\n\n🎁 | <b>Трейды :\n\n✉️ | Конверты : <code>{ktt}</code>\n🧧 | Редкие Конверты : <code>{rkkt}</code>\n📦 | Кейсы : <code>{kk}</code>\n🗳 | Редкий Кейс : <code>{rkk}</code>\n🕋 | Мифический Кейс : <code>{miff}</code>\n💎 | Кристальный Кейс : <code>{kkr}</code>\n🌌 | Звёздный Кейс : <code>{zvv}</code></b>\n\n<b>📚 | Прочее :\n\n🌐 | Плазмы с 'thx' когда благодаришь ты : <code>{pthx}</code>\n🌐 | Плазмы с 'thx' когда благодарят тебя :</b> <code>{ppthx}</code>")
        ...
        if wwwww < 1 and ddddd > 0:
            await self.client.send_message(
                message.peer_id,
                f"<b>📊 | Статистика игрока <code>{im}</code></b>за <i>{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>\n\n<b>🧱 | В шахте :</b>\n\n👆 | <b>За <code>{klks}</code> {klkr}\n\n<b>✉️ | Конверт : <code>{kt1}</code>\n🧧 | Редкий Конверт : <code>{rkt1}</code>\n📦 | Кейс : <code>{k1}</code>\n🗳 | Редкий Кейс : <code>{rk1}</code>\n🕋 | Мифический Кейс : <code>{mif1}</code>\n💎 | Кристальный Кейс : <code>{kr1}</code>\n🌌 | Звёздный Кейс : <code>{zv1}</code></b> \n<i>Всего кейсов с шахты:</i> <code>{shcs}</code>\n\n<b>🎆 | Плазма : <code>{p}</code>\n⚡️ | Бусты : <code>{boostsss}</code></b>\n\n☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>\n\n🎁 | <b>Трейды :\n\n✉️ | Конверты : <code>{ktt}</code>\n🧧 | Редкие Конверты : <code>{rkkt}</code>\n📦 | Кейсы : <code>{kk}</code>\n🗳 | Редкий Кейс : <code>{rkk}</code>\n🕋 | Мифический Кейс : <code>{miff}</code>\n💎 | Кристальный Кейс : <code>{kkr}</code>\n🌌 | Звёздный Кейс : <code>{zvv}</code></b>\n\n<b>📚 | Прочее :\n\n🌐 | Плазмы с 'thx' когда благодаришь ты : <code>{pthx}</code>\n🌐 | Плазмы с 'thx' когда благодарят тебя :</b> <code>{ppthx}</code>")
        ...
        if mmmmmth < 1 and wwwww > 0:
            await self.client.send_message(
                message.peer_id,
                f"<b>📊 | Статистика игрока <code>{im}</code></b>за <i>{wwww}нед.{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>\n\n<b>🧱 | В шахте :</b>\n\n👆 | <b>За <code>{klks}</code> {klkr}\n\n<b>✉️ | Конверт : <code>{kt1}</code>\n🧧 | Редкий Конверт : <code>{rkt1}</code>\n📦 | Кейс : <code>{k1}</code>\n🗳 | Редкий Кейс : <code>{rk1}</code>\n🕋 | Мифический Кейс : <code>{mif1}</code>\n💎 | Кристальный Кейс : <code>{kr1}</code>\n🌌 | Звёздный Кейс : <code>{zv1}</code></b> \n<i>Всего кейсов с шахты:</i> <code>{shcs}</code>\n\n<b>🎆 | Плазма : <code>{p}</code>\n⚡️ | Бусты : <code>{boostsss}</code></b>\n\n☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>\n\n🎁 | <b>Трейды :\n\n✉️ | Конверты : <code>{ktt}</code>\n🧧 | Редкие Конверты : <code>{rkkt}</code>\n📦 | Кейсы : <code>{kk}</code>\n🗳 | Редкий Кейс : <code>{rkk}</code>\n🕋 | Мифический Кейс : <code>{miff}</code>\n💎 | Кристальный Кейс : <code>{kkr}</code>\n🌌 | Звёздный Кейс : <code>{zvv}</code></b>\n\n<b>📚 | Прочее :\n\n🌐 | Плазмы с 'thx' когда благодаришь ты : <code>{pthx}</code>\n🌐 | Плазмы с 'thx' когда благодарят тебя :</b> <code>{ppthx}</code>")
        ...
        if y < 1 and mmmmmth > 0:
            await self.client.send_message(
                message.peer_id,
                f"<b>📊 | Статистика игрока <code>{im}</code></b>за <i>{mmmmth}мес.{wwww}нед.{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>\n\n<b>🧱 | В шахте :</b>\n\n👆 | <b>За <code>{klks}</code> {klkr}\n\n<b>✉️ | Конверт : <code>{kt1}</code>\n🧧 | Редкий Конверт : <code>{rkt1}</code>\n📦 | Кейс : <code>{k1}</code>\n🗳 | Редкий Кейс : <code>{rk1}</code>\n🕋 | Мифический Кейс : <code>{mif1}</code>\n💎 | Кристальный Кейс : <code>{kr1}</code>\n🌌 | Звёздный Кейс : <code>{zv1}</code></b> \n<i>Всего кейсов с шахты:</i> <code>{shcs}</code>\n\n<b>🎆 | Плазма : <code>{p}</code>\n⚡️ | Бусты : <code>{boostsss}</code></b>\n\n☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>\n\n🎁 | <b>Трейды :\n\n✉️ | Конверты : <code>{ktt}</code>\n🧧 | Редкие Конверты : <code>{rkkt}</code>\n📦 | Кейсы : <code>{kk}</code>\n🗳 | Редкий Кейс : <code>{rkk}</code>\n🕋 | Мифический Кейс : <code>{miff}</code>\n💎 | Кристальный Кейс : <code>{kkr}</code>\n🌌 | Звёздный Кейс : <code>{zvv}</code></b>\n\n<b>📚 | Прочее :\n\n🌐 | Плазмы с 'thx' когда благодаришь ты : <code>{pthx}</code>\n🌐 | Плазмы с 'thx' когда благодарят тебя :</b> <code>{ppthx}</code>")
        ...
        if y > 0:
            await self.client.send_message(
                message.peer_id,
                f"<b>📊 | Статистика игрока <code>{im}</code></b>за <i>{y}г.{mmmmth}мес.{wwww}нед.{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>\n\n<b>🧱 | В шахте :</b>\n\n👆 | <b>За <code>{klks}</code> {klkr}\n\n<b>✉️ | Конверт : <code>{kt1}</code>\n🧧 | Редкий Конверт : <code>{rkt1}</code>\n📦 | Кейс : <code>{k1}</code>\n🗳 | Редкий Кейс : <code>{rk1}</code>\n🕋 | Мифический Кейс : <code>{mif1}</code>\n💎 | Кристальный Кейс : <code>{kr1}</code>\n🌌 | Звёздный Кейс : <code>{zv1}</code></b> \n<i>Всего кейсов с шахты:</i> <code>{shcs}</code>\n\n<b>🎆 | Плазма : <code>{p}</code>\n⚡️ | Бусты : <code>{boostsss}</code></b>\n\n☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>\n\n🎁 | <b>Трейды :\n\n✉️ | Конверты : <code>{ktt}</code>\n🧧 | Редкие Конверты : <code>{rkkt}</code>\n📦 | Кейсы : <code>{kk}</code>\n🗳 | Редкий Кейс : <code>{rkk}</code>\n🕋 | Мифический Кейс : <code>{miff}</code>\n💎 | Кристальный Кейс : <code>{kkr}</code>\n🌌 | Звёздный Кейс : <code>{zvv}</code></b>\n\n<b>📚 | Прочее :\n\n🌐 | Плазмы с 'thx' когда благодаришь ты : <code>{pthx}</code>\n🌐 | Плазмы с 'thx' когда благодарят тебя :</b> <code>{ppthx}</code>")
    ...
    async def ibackl(self,call: InlineCall):
        ...
        if hhhhh < 1 and mmmmm > 1:
            await call.edit(
                text=f"<b>📊 | Статистика игрока {im}</b>за <i>{mmmm}мин.{ss}с.:</i>",
                reply_markup=[
                     [
                    {
                        "text" : "🧱 Шахта",
        ...
        if ddddd < 1 and hhhhh > 0:
            await call.edit(
                f"<b>📊 | Статистика игрока {im}</b>за <i>{hhhh}ч.{mmmm}мин.{ss}с.:</i>",
                reply_markup=[
                     [
                    {
                        "text" : "🧱 Шахта",
        ...
        if wwwww < 1 and ddddd > 0:
            await call.edit(
                f"<b>📊 | Статистика игрока {im}</b>за <i>{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>",
                reply_markup=[
                     [
                    {
                        "text" : "🧱 Шахта",
        ...
        if mmmmmth < 1 and wwwww > 0:
            await call.edit(
                f"<b>📊 | Статистика игрока {im}</b>за <i>{wwww}нед.{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>",
                reply_markup=[
                     [
                    {
                        "text" : "🧱 Шахта",
        ...
        if y < 1 and mmmmmth > 0:
            await call.edit(
                f"<b>📊 | Статистика игрока {im}</b>за <i>{mmmmth}мес.{wwww}нед.{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>",
                reply_markup=[
                     [
                    {
                        "text" : "🧱 Шахта",
        ...
        if y > 0:
            await call.edit(
                f"<b>📊 | Статистика игрока {im}</b>за <i>{y}г.{mmmmth}мес.{wwww}нед.{dddd}д.{hhhh}ч.{mmmm}мин.{ss}с.:</i>",
                reply_markup=[
                     [
                    {
                        "text" : "🧱 Шахта",
    ...
    async def ibackd(self,call: InlineCall):
        im = self.get("im", None)
        await call.edit(
            text=f"<b>📊 | Статистика игрока {im} за сегодня</b>:",
            reply_markup=[
                [
                    {
                        "text" : "🧱 Шахта",
    ...
    async def ibssd(self,call: InlineCall):
        ...
        if bbb in ["1"] and bbbb in ["1"]:
            bssr = "боссов"
        await call.edit(
            text=f"☠️ | <b>С <code>{bssd}</code> {bssr} | Добиты тобой : <code>{bskldd}</code>\n\n🔩 | Скрап : <code>{skp}</code>\n🎆 | Плазма : <code>{bspd}</code>\n🎖 | Медали : <code>{mbp}</code>\n📦 | Кейсы : <code>{bskbd}</code>\n🗳 | Редкие Кейсы : <code>{bsrkbd}</code>\n🕋 | Мифические Кейсы : <code>{bsmifbd}</code>\n🩸 | Всего нанесено урона : <code>{bddmg}</code>\n💢 | Критического урона: <code>{bkddmg}</code>\n🗡 | Нанесено ударов : </b><code>{bsknd}</code>",
            reply_markup=[
                [
                    {
                        'text' : "🔙 Назад",
    ...
    async def ibss(self,call: InlineCall):
        ...
        if bbb in ["1"] and bbbb in ["1"]:
            bssr = "боссов"
        await call.edit(
            text=f"☠️ | <b>С <code>{bss}</code> {bssr} | Добиты тобой : <code>{bskld}</code>\n\n🔩 | Скрап : <code>{sb}</code>\n🎆 | Плазма : <code>{pb}</code>\n🎖 | Медали : <code>{mb}</code>\n📦 | Кейсы : <code>{kb}</code>\n🗳 | Редкие Кейсы : <code>{rkb}</code>\n🕋 | Мифические Кейсы : <code>{mmb}</code>\n🩸 | Всего нанесено урона : <code>{bdmg}</code>\n💢 | Критического урона: <code>{bkdmg}</code>\n🗡 | Нанесено ударов : <code>{bskn}</code></b>",
            reply_markup=[
                [
                    {
                        'text' : "🔙 Назад",
