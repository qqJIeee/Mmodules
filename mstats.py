...
class mstats(loader.Module):
    ...
    async def watcher(self, message):
        ...
        if now.hour == 0 and now.minute == 0: 
            ...
            self.set('dkd', 0)
            self.set('dkktd', 0)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Найден" in message.raw_text:
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "✉" in message.raw_text and "Конверт" in message.raw_text:
                colpt = r"\d+"
                ...
                self.set("ktd1", ktd1)
                self.set("kt1",kt1)
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🧧" in message.raw_text and "Редкий Конверт" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
                ...
                self.set("rkt1",rkt1)
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "📦" in message.raw_text and "Кейс" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
                ...
                self.set("kd1", kd1)
                self.set("k1",k1)
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🗳" in message.raw_text and "Редкий Кейс" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
                ...
                self.set("rkd1", rkd1)
                self.set("rk1",rk1)
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🕋" in message.raw_text and "Мифический Кейс" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
            ...
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Портфель" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
            ...
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Сумка" in message.raw_text:    
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
            ...
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "💎" in message.raw_text and "Кристальный Кейс" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
                ...
                self.set("krd1", krd1)
                self.set("kr1",kr1)
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🎲" in message.raw_text and "Дайс Кейс" in message.raw_text:
                colpt = r"\d+"
                search = re.search(colpt, message.raw_text)
                colvo = int(search[0])
                ...
                self.set('dk', dk)
                self.set('dkd', dkd)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "💫" in message.raw_text:
            zv1 += 1
            zvd1 += 1
            self.set("zvd1", zvd1)
            self.set("zv1",zv1)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Плазма +" in message.raw_text and "Руда на уровень" in message.raw_text:
            plpt = r"\d+"
        ...
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "нанес(ла)" in message.raw_text:
            bskn += 1
            bsknd += 1
            self.set("bsknd", bsknd)
            self.set("bskn",bskn)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Медаль" in message.raw_text:
            pattern = "Медаль +(.*?)</b>"
            ...
            if match:
                ...
                self.set("mbp",mbp)
                self.set("mb",mb)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Скрап" in message.raw_text:
            pattern = "Скрап +(.*?)</b>"
            match = re.search(pattern, message.text, re.DOTALL)
            if match:
                ...
                self.set("sb",sb)
                self.set("skp",skp)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "✨ Твоя награда:" in message.raw_text:
            pattern = "Плазма +(.*?)</b>"
            match = re.search(pattern, message.text, re.DOTALL)
            if match:
                pbm = match.group(1)
                ...
                self.set("pb",pb)
                self.set("dayp",dayp)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Руда на уровень" in message.raw_text:
            klks += 1
            klksd += 1
        ...
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "✨ Твоя награда:" in message.raw_text:
            ...
            self.set("bssd",bssd)
            self.set("bss",bss)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🗳 | Редкий Кейс +" in message.raw_text:
            ...
            self.set("rkb",rkb)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Эссенция +" in message.raw_text:
            espt = "Эссенция +(.*?)</b>"
            ...
            self.set('es', es)
            self.set('esd', esd)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "📦 | Кейс +" in message.raw_text:
            pattern = "<b>Кейс +(.*?)</b>"
            match = re.search(pattern, message.text, re.DOTALL)
            if match:
                ...
                self.set("kb",kb)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🕋 | Мифический Кейс +" in message.raw_text:
            ...
            self.set("mmb",mmb)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "💳" in message.text and 'перечислил(а) тебе ' in message.text:
            ...
            self.set('crd',crd)
            self.set('crdd', crdd)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Награда и статистика отображена в лс с ботом" in message.raw_text:
            bskld += 1
            bskldd += 1
            self.set("bskldd",bskldd)
            self.set("bskld",bskld)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🎆" in message.raw_text and "ты поблагодарил(а) игрока" in message.raw_text:
            ...
            if l == self.get('im'):
                ...
                self.set("pthx",pthx)
                self.set("dayp",dayp)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🎆" in message.raw_text and "поблагодарил(а) тебя" in message.raw_text:
            ...
            self.set("dayp",dayp)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "передал(а) тебе" in message.text and "📦" in message.text:
        ...
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "передал(а) тебе" in message.text and "🌌" in message.text:
            ...
            self.set('zvv', zvv)
            self.set('zvvd', zvvd)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "🗡" in message.raw_text and "нанес(ла) удар" in message.raw_text:
            dpt = "<b>-(.*?) оз"
            ...
            self.set("bdmg",bdmg)
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "💢" in message.raw_text and "нанес(ла) крит. удар" in message.raw_text:
            kdpt = "<b>-(.*?) оз"
        ...
        if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер:" in message.raw_text:
            boostsss += 1
            boostd += 1
