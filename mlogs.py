...
class mlogs(loader.Module):
    ...
    async def watcher(self, message):
        ...
        if self.get('tradec'):                
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "передал(а) тебе" in message.raw_text:
                nick = "<code>(.*?)</code>"
                kolvo = "тебе  (.*?) шт."
        ...
        if self.get('tradei'):
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "Получен предмет" in message.raw_text:
                nick = "Игрок  (.*?) передал"
                item = 'тебе :\n(.+)'
        ...
        if self.get('bosses'):
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "побежден игроком" in message.raw_text:
                await self.inline.bot.send_message(chid, message.text)
        
        if self.get('boosters'):
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Руда ×2.0!" in message.raw_text:
                    await self.inline.bot.send_message(chid, self.get('boostersr2'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Деньги ×2.0!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersd2'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Деньги ×1.5!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersd1.5'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Руда ×1.5!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersr1.5'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Деньги ×2.5!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersd2.5'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Руда ×2.5!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersr2.5'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Деньги ×3.0!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersr3'))
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.raw_text and "бустер: Руда ×3.0!" in message.raw_text:
                await self.inline.bot.send_message(chid, self.get('boostersd3'))
                
        if self.get('credits'):
            if hasattr(message, 'from_id') and message.from_id == 7168860714 and message.chat_id == 7168860714 or message.from_id == 5522271758 and message.chat_id == 5522271758 and "💳" in message.raw_text and 'перечислил(а) тебе ' in message.raw_text:
                nickc = "<code>(.*?)</code>"
                kolvoc = "тебе (.*?) эво"
