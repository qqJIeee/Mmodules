...
class mlogs(loader.Module):
    ...
    async def watcher(self, message):
        ...
        if self.get('boosters'):
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Руда ×2.0!" in message.raw_text:
                    await self.client.send_message("mlogs", "⚡️ <b>Буст руды 2.0 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Деньги ×2.0!" in message.raw_text:
                await self.client.send_message("mlogs", "⚡️ <b>Буст денег 2.0 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Деньги ×1.5!" in message.raw_text:
                await self.client.send_message("mlogs", "⚡️ <b>Буст денег 1.5 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Руда ×1.5!" in message.raw_text:
                await self.client.send_message("mlogs", "⚡️ <b>Буст руды 1.5 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Деньги ×2.5!" in message.raw_text:
                await self.client.send_message("mlogs", "⚡️ <b>Буст денег 2.5 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Руда ×2.5!" in message.raw_text:
                await self.client.send_message("mlogs", "⚡️ <b>Буст руды 2.5 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Деньги ×3.0!" in message.raw_text:
                await self.client.send_message("mlogs", "⚡️ <b>Буст денег 3.0 </b><i>+1</i>")
            if hasattr(message, 'from_id') and message.from_id == 5522271758 and message.chat_id == 5522271758 and "ты нашел(ла)" in message.text and "бустер: Руда ×3.0!" in message.raw_text:
